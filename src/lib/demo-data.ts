...
const DEMO_PROPERTIES = [
  ...
  {
    name: "Vieux-Lille Loft",
    address: "24 Rue de la Monnaie",
    city: "Lille",
    country: "France",
    propertyType: "apartment",
    residencyStatus: "primary",
    airbnbUrl: "https://airbnb.com/rooms/example-lille",
    registrationNumber: null,
    issuingAuthority: "Ville de Lille — Direction de l'Habitat",
    status: "pending",
    issueDate: null,
    expiryDate: null,
  },
  {
    name: "Capitole Studio",
    address: "5 Place du Capitole",
    city: "Toulouse",
    country: "France",
    propertyType: "studio",
    residencyStatus: "secondary",
    bookingUrl: "https://booking.com/hotel/example-toulouse",
    registrationNumber: null,
    issuingAuthority: "Mairie de Toulouse — Mission Meublés de tourisme",
    status: "not_started",
    issueDate: null,
    expiryDate: null,
  },
  ...
  for (const demo of DEMO_PROPERTIES) {
    ...
    const property = await prisma.property.create({
      data: {
        ...
        residencyStatus: demo.residencyStatus ?? null,
