    ...
    <section className="space-y-3">
      ...
      {hasAttention && (
        <div className="space-y-2">
          ...
          {stats.nationalTransition > 0 && (
            <Link
              href={propertiesListHref(locale, { status: "national_transition" })}
              className="flex items-center justify-between gap-3 rounded-lg border border-blue-200 bg-blue-50 px-3 py-2.5 text-blue-900 transition-colors hover:bg-blue-100"
            >
              <div className="flex min-w-0 items-center gap-2">
                <AlertTriangle className="h-4 w-4 shrink-0 text-blue-600" />
                <p className="text-sm font-medium leading-snug">
                  {t("attention.nationalTransition", { count: stats.nationalTransition })}
                </p>
              </div>
          ...
          {stats.greeceAma > 0 && (
            <Link
              href={propertiesListHref(locale, { status: "greece_ama" })}
              className="flex items-center justify-between gap-3 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2.5 text-emerald-900 transition-colors hover:bg-emerald-100"
            >
              <div className="flex min-w-0 items-center gap-2">
                <AlertTriangle className="h-4 w-4 shrink-0 text-emerald-600" />
                <p className="text-sm font-medium leading-snug">
                  {t("attention.greeceAma", { count: stats.greeceAma })}
                </p>
              </div>
          ...
          {stats.croatiaEvisitor > 0 && (
            <Link
              href={propertiesListHref(locale, { status: "croatia_evisitor" })}
              className="flex items-center justify-between gap-3 rounded-lg border border-red-200 bg-red-50 px-3 py-2.5 text-red-900 transition-colors hover:bg-red-100"
            >
              <div className="flex min-w-0 items-center gap-2">
                <AlertTriangle className="h-4 w-4 shrink-0 text-red-600" />
                <p className="text-sm font-medium leading-snug">
                  {t("attention.croatiaEvisitor", { count: stats.croatiaEvisitor })}
                </p>
              </div>
              <ChevronRight className="h-4 w-4 shrink-0 text-red-600" />
            </Link>
          ...
          {stats.netherlandsRegistration > 0 && (
            <Link
              href={propertiesListHref(locale, { status: "netherlands_registration" })}
              className="flex items-center justify-between gap-3 rounded-lg border border-orange-200 bg-orange-50 px-3 py-2.5 text-orange-900 transition-colors hover:bg-orange-100"
            >
              <div className="flex min-w-0 items-center gap-2">
                <AlertTriangle className="h-4 w-4 shrink-0 text-orange-600" />
                <p className="text-sm font-medium leading-snug">
                  {t("attention.netherlandsRegistration", {
                    count: stats.netherlandsRegistration,
                  })}
                </p>
              </div>
          ...
          {stats.belgiumRegistration > 0 && (
            <Link
              href={propertiesListHref(locale, { status: "belgium_registration" })}
              className="flex items-center justify-between gap-3 rounded-lg border border-yellow-200 bg-yellow-50 px-3 py-2.5 text-yellow-900 transition-colors hover:bg-yellow-100"
            >
              <div className="flex min-w-0 items-center gap-2">
                <AlertTriangle className="h-4 w-4 shrink-0 text-yellow-700" />
                <p className="text-sm font-medium leading-snug">
                  {t("attention.belgiumRegistration", {
                    count: stats.belgiumRegistration,
                  })}
                </p>
              </div>
